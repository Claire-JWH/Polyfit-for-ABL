...
def main(NUM):
    Jlabel = ['J13', 'J12', 'J11', 'J21', 'J22', 'J23']
    Tlabel = ['T13', 'T12', 'T11', 'T21', 'T22', 'T23']
    Rlabel = ['R13', 'R12', 'R11', 'R21', 'R22', 'R23']
    Clabel = ['C13', 'C12', 'C11', 'C21', 'C22', 'C23']
    Glabel = ['G1314', 'G1413', 'G1213', 'G1312', 'G1112', 'G1211', 'G1121', 'G2111', 'G2122', 'G2221', 'G2223',
              'G2322', 'G2324', 'G2423']
    Olabel = ['O1314', 'O1413', 'O1213', 'O1312', 'O1112', 'O1211', 'O1121', 'O2111', 'O2122', 'O2221', 'O2223',
              'O2322', 'O2324', 'O2423']
    ...
    wk_sheet.cell(row=54, column=6, value=H1)  # 在第12行，第6列下插入“H1”数值
    wk_sheet.cell(row=55, column=6, value=H2)
    wk_sheet.cell(row=56, column=6, value=H3)
    # wk_sheet.cell(row=57, column=6, value=H4)
    # wk_sheet.cell(row=58, column=6, value=H5)

    wk_sheet.cell(row=59, column=6, value=L1)  # 在第17行，第6列下插入“L1”数值
    wk_sheet.cell(row=60, column=6, value=L2)
    wk_sheet.cell(row=61, column=6, value=L3)
    wk_sheet.cell(row=62, column=6, value=L4)
    wk_sheet.cell(row=63, column=6, value=L5)

    # n2＞n1＞n3
    if n2 > n1 > n3:
        wk_sheet.cell(row=64, column=6, value=n0)
        wk_sheet.cell(row=65, column=6, value=n1)
        wk_sheet.cell(row=66, column=6, value=n2)
        wk_sheet.cell(row=67, column=6, value=n3)
    else:
        wk_sheet.cell(row=64, column=6, value=n0).fill = fille
        wk_sheet.cell(row=65, column=6, value=n1).fill = fille
        wk_sheet.cell(row=66, column=6, value=n2).fill = fille
        wk_sheet.cell(row=67, column=6, value=n3).fill = fille

    wk_sheet_1 = wb['拟合程度']
    wk_sheet_1.cell(row=4, column=23, value=correlation_coefficient1)
    wk_sheet_1.cell(row=4, column=24, value=correlation_coefficient2)
    wk_sheet_1.cell(row=4, column=25, value=correlation_coefficient3)
    wk_sheet_1.cell(row=4, column=26, value=correlation_coefficient4)
    wk_sheet_1.cell(row=4, column=27, value=correlation_coefficient5)
    wk_sheet_1.cell(row=4, column=28, value=correlation_coefficient6)
