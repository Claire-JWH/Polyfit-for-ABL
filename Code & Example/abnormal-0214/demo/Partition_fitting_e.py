...
def main(NUM):
    Jlabel = ['J33', 'J32', 'J31', 'J41', 'J42', 'J43']
    Tlabel = ['T33', 'T32', 'T31', 'T41', 'T42', 'T43']
    Rlabel = ['R33', 'R32', 'R31', 'R41', 'R42', 'R43']
    Clabel = ['C33', 'C32', 'C31', 'C41', 'C42', 'C43']
    Glabel = ['G3334', 'G3433', 'G3233', 'G3332', 'G3132', 'G3231', 'G3141', 'G4131', 'G4142', 'G4241', 'G4243',
              'G4342', 'G4344', 'G4443']
    Olabel = ['O3334', 'O3433', 'O3233', 'O3332', 'O3132', 'O3231', 'O3141', 'O4131', 'O4142', 'O4241', 'O4243',
              'O4342', 'O4344', 'O4443']
    ...
    wk_sheet.cell(row=54, column=12, value=H1)  # 在第12行，第12列下插入“H1”数值
    wk_sheet.cell(row=55, column=12, value=H2)
    wk_sheet.cell(row=56, column=12, value=H3)
    # wk_sheet.cell(row=57, column=12, value=H4)
    # wk_sheet.cell(row=58, column=12, value=H5)

    wk_sheet.cell(row=59, column=12, value=L1)  # 在第17行，第12列下插入“L1”数值
    wk_sheet.cell(row=60, column=12, value=L2)
    wk_sheet.cell(row=61, column=12, value=L3)
    wk_sheet.cell(row=62, column=12, value=L4)
    wk_sheet.cell(row=63, column=12, value=L5)

    # n2＞n1＞n3
    if n2 > n1 > n3:
        wk_sheet.cell(row=64, column=12, value=n0)
        wk_sheet.cell(row=65, column=12, value=n1)
        wk_sheet.cell(row=66, column=12, value=n2)
        wk_sheet.cell(row=67, column=12, value=n3)
    else:
        wk_sheet.cell(row=64, column=12, value=n0).fill=fille
        wk_sheet.cell(row=65, column=12, value=n1).fill=fille
        wk_sheet.cell(row=66, column=12, value=n2).fill=fille
        wk_sheet.cell(row=67, column=12, value=n3).fill=fille

    wk_sheet_1 = wb['拟合程度']
    wk_sheet_1.cell(row=4, column=41, value=correlation_coefficient1)
    wk_sheet_1.cell(row=4, column=42, value=correlation_coefficient2)
    wk_sheet_1.cell(row=4, column=43, value=correlation_coefficient3)
    wk_sheet_1.cell(row=4, column=44, value=correlation_coefficient4)
    wk_sheet_1.cell(row=4, column=45, value=correlation_coefficient5)
    wk_sheet_1.cell(row=4, column=46, value=correlation_coefficient6)
