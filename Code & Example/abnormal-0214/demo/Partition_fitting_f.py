...
def main(NUM):
    Jlabel = ['J47', 'J46', 'J45', 'J44']
    Tlabel = ['T47', 'T46', 'T45', 'T44']
    Rlabel = ['R47', 'R46', 'R45', 'R44']
    Clabel = ['C47', 'C46', 'C45', 'C44']
    Glabel = ['G4344', 'G4443', 'G4445', 'G4544', 'G4546', 'G4645', 'G4647', 'G4746']
    Olabel = ['O4344', 'O4443', 'O4445', 'O4544', 'O4546', 'O4645', 'O4647', 'O4746']
    ...
    wk_sheet.cell(row=26, column=12, value=H1)  # 在第12行，第12列下插入“H1”数值
    wk_sheet.cell(row=27, column=12, value=H2)
    wk_sheet.cell(row=28, column=12, value=H3)
    # wk_sheet.cell(row=29, column=12, value=H4)
    # wk_sheet.cell(row=30, column=12, value=H5)

    wk_sheet.cell(row=31, column=12, value=L1)  # 在第17行，第12列下插入“L1”数值
    wk_sheet.cell(row=32, column=12, value=L2)
    wk_sheet.cell(row=33, column=12, value=L3)
    wk_sheet.cell(row=34, column=12, value=L4)
    wk_sheet.cell(row=35, column=12, value=L5)

    # n2＞n1＞n3
    if n2 > n1 > n3:
        wk_sheet.cell(row=36, column=12, value=n0)
        wk_sheet.cell(row=37, column=12, value=n1)
        wk_sheet.cell(row=38, column=12, value=n2)
        wk_sheet.cell(row=39, column=12, value=n3)
    else:
        wk_sheet.cell(row=36, column=12, value=n0).fill = fille
        wk_sheet.cell(row=37, column=12, value=n1).fill = fille
        wk_sheet.cell(row=38, column=12, value=n2).fill = fille
        wk_sheet.cell(row=39, column=12, value=n3).fill = fille


    wk_sheet_1 = wb['拟合程度']
    wk_sheet_1.cell(row=4, column=47, value=correlation_coefficient1)
    wk_sheet_1.cell(row=4, column=48, value=correlation_coefficient2)
    wk_sheet_1.cell(row=4, column=49, value=correlation_coefficient3)
    wk_sheet_1.cell(row=4, column=50, value=correlation_coefficient4)
    wk_sheet_1.cell(row=4, column=51, value=correlation_coefficient5)
    wk_sheet_1.cell(row=4, column=52, value=correlation_coefficient6)
