...
def main(NUM):
    Jlabel = ['J17', 'J16', 'J15', 'J14']
    Tlabel = ['T17', 'T16', 'T15', 'T14']
    Rlabel = ['R17', 'R16', 'R15', 'R14']
    Clabel = ['C17', 'C16', 'C15', 'C14']
    Glabel = ['G1314', 'G1413', 'G1415', 'G1514', 'G1516', 'G1615', 'G1617', 'G1716']
    Olabel = ['O1314', 'O1413', 'O1516', 'O1514', 'O1516', 'O1615', 'O1617', 'O1716']
    ...
    wk_sheet.cell(row=26, column=6, value=H1)  # 在第12行，第6列下插入“H1”数值
    wk_sheet.cell(row=27, column=6, value=H2)
    wk_sheet.cell(row=28, column=6, value=H3)
    # wk_sheet.cell(row=29, column=6, value=H4)
    # wk_sheet.cell(row=30, column=6, value=H5)

    wk_sheet.cell(row=31, column=6, value=L1)  # 在第17行，第6列下插入“L1”数值
    wk_sheet.cell(row=32, column=6, value=L2)
    wk_sheet.cell(row=33, column=6, value=L3)
    wk_sheet.cell(row=34, column=6, value=L4)
    wk_sheet.cell(row=35, column=6, value=L5)

    # n2＞n1＞n3
    if n2 > n1 > n3:
        wk_sheet.cell(row=36, column=6, value=n0)
        wk_sheet.cell(row=37, column=6, value=n1)
        wk_sheet.cell(row=38, column=6, value=n2)
        wk_sheet.cell(row=39, column=6, value=n3)
    else:
        wk_sheet.cell(row=36, column=6, value=n0).fill = fille
        wk_sheet.cell(row=37, column=6, value=n1).fill = fille
        wk_sheet.cell(row=38, column=6, value=n2).fill = fille
        wk_sheet.cell(row=39, column=6, value=n3).fill = fille

    wk_sheet_1 = wb['拟合程度']
    wk_sheet_1.cell(row=4, column=17, value=correlation_coefficient1)
    wk_sheet_1.cell(row=4, column=18, value=correlation_coefficient2)
    wk_sheet_1.cell(row=4, column=19, value=correlation_coefficient3)
    wk_sheet_1.cell(row=4, column=20, value=correlation_coefficient4)
    wk_sheet_1.cell(row=4, column=21, value=correlation_coefficient5)
    wk_sheet_1.cell(row=4, column=22, value=correlation_coefficient6)
